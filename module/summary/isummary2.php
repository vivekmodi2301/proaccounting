...
//echo "hi";
	...
	if(isset($_POST['client'])){
    	...
    	if($cid){
    		$re=mysqli_query($con,"select id,invoiceno,invoicedate as datee,netamm,`status` from invoice where coid=$id and cid=$cid and  invoicedate BETWEEN '$fdatee' AND '$tdatee' order by invoicedate asc
");	
    	}else{
    		$re=mysqli_query($con," select id,invoiceno,invoicedate as datee,netamm,`status` from invoice where coid=$id and  invoicedate BETWEEN '$fdatee' AND '$tdatee' order by id asc
");
    	}
