...
session_start();
	...
	if(isset($_GET['id']) && $_GET['id']){
		//echo "hi";exit;
		$id=$_GET['id'];
		$reciptdata=mysqli_fetch_assoc(mysqli_query($con,"select cash.id,name,ammount,datee,reciptid,payby,bankname,cheque,narration from cash join client on cid=client.id where cash.id=$id"));
	}
...
<div style="border:1px solid; width:150px; padding-left:15px; font-size:20px;">Recipt</div>
<table border="1px" width="100%" cellspacing="0" style=" margin-top:5px">
    ...
    <tr style="text-align:center;">
    	<td><?php echo $reciptdata['reciptid'];?></td>
