<?php
	if(isset($_POST['name'])){
		...
		mkdir("data/$_POST[name]");
		?>
        	<script>
				location.href="index.php?mod=company&do=login";
			</script>
        <?php
	}?>		
...
$(function(){
    ...
    $("#fdate").datepicker({ dateFormat: 'yy-mm-dd' }).bind("change",function(){
...
<br />
	<div style="float:left; width:300px">Financial Year From:</div> <div><input type="text" id="fdate" name="astart" placeholder="01/01/2000"></div>
<br />
